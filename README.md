...
graph TD
    ...
    style CA fill:#1a1a1a,stroke:#fff,color:#fff
    style DB fill:#2a2a2a,stroke:#888,color:#fff
    style MP fill:#2a2a2a,stroke:#888,color:#fff
    style SF fill:#2a2a2a,stroke:#888,color:#fff
    style CN fill:#2a2a2a,stroke:#888,color:#fff
    style RP fill:#2a2a2a,stroke:#888,color:#fff
```
...
We focus on the concept phase. For the rest of the project lifecycle, there is real depth elsewhere. The two are complementary.

Architecture needs more open tools. We are all doing this together.

Inspired to open-source our skills by [Architecture Studio](https://github.com/AlpacaLabsLLC/skills-for-architects) by [ALPA](https://alpa.llc) (Federico Negro). For zoning, specs, sustainability, and procurement, check them out first.
